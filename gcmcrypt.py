...
def print_usage():
    ...
    print("Usage is : ")
    print("\tGcmCrypt -e|-d [-f] [-compress] password infile outfile. ")
    print()
    print("Examples:")
    print("\tGcmCrypt -e -compress mypass myinputfile myencryptedoutputfile")
    print("\tGcmCrypt -d mypass myencryptedinputfile mydecryptedoutputfile")
    print()
